...
public class AccessModifiers_Test2 {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(AccessModifiers.privateData);//private Access Modifier is not visible outside the class,package

        AccessModifiers.method1();
        //AccessModifiers.method2(); //default Access Modifier is not visible outside the package
        //AccessModifiers.method3(); //private Access Modifier is not visible outside the class,package
